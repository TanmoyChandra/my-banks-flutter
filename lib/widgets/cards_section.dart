            ...
            child: ReorderableListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final totalDue = cardTxs.fold(
                  0.0,
                  (sum, t) =>
                      t.type == 'debit' ? sum + t.amount : sum - t.amount,
                );
...
class _BankCardState extends State<_BankCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayNumber = _showFull
        ? _formatCardNumber(widget.card.cardNumber)
        : _maskCardNumber(widget.card.cardNumber);
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          (widget.card.holderName.isNotEmpty
